package de.appsist.service.auth.connector.model;
...
public class User {
	...
	public static String[] getRestrictedFields() {
		return new String[]{"id", "firstName", "lastName", "displayName", "position", "mail", "resources", "mobile"};
	}
	 ...
	 * @return Mobile phone number. May be <code>null</code>.
	 */
	 ...
	 * @param mobile Mobile phone number to set. May be <code>null</code>.
	 */
	public void setMobile(String mobile) {
		if (mobile != null) {
			json.putString("mobile", mobile);
		} else {
	...
	/**
	 * Caches a token to be used for user authentication.
	 * The token is NOT stored in the JSON representation.
	...
	/**
	 * Returns the token cached for user authentication.
	 * @return Cached token or <code>null</code>.
	 */
